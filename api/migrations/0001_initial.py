# Generated by Django 4.1.1 on 2022-12-16 12:36
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('_accessible_mode', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='api.accessiblemode')),
                ('_name', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='api.accessibleelement', unique=True)),
                ('_text_size', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='api.textsize')),
            ],
        ),
        migrations.CreateModel(
