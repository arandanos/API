...
COPY public.api_kitchenorder (_id, _task_id) FROM stdin;
1	1
\.
...
SELECT pg_catalog.setval('public.api_accessibleelement__id_seq', 1, false);
...
SELECT pg_catalog.setval('public.api_kitchenorder__id_seq', 1, false);
